    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                @if(Auth::check() && Auth::User()->is_admin)
                    <li>
                        <a href="" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage Position</a>
                    </li> 
                @else
                    <li>
                ...
                @endif
                <li>
                    <a href="{{ route('admin.leave.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage Employee</a>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Appraisal</span>
