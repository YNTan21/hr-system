        ...
        <div class="row px-3">
            <div class="col-xl-2 col-lg-3">
                <div class="d-none d-xl-block d-lg-block">
                    <x-dashboard.sidebar2></x-dashboard.sidebar2>
                </div>
            </div>
            <!-- Main Content -->
                ...
                <div class="leaveType-create p-4 border shadow-sm" style="background-color=#fff">
                    ...
                    <form action="{{route('leaveType.store')}}" method="post">
                        ...
                        <div class="mb-3 px-5 py-2">
                            ...
                            <input type="text" id="leaveType" class="form-control" name="leaveType" value="{{ old('leaveType') }}" required>
                            @error('leaveType')
                                <p class="error">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="mb-3 px-5">
                            ...
                            <input type="text" id="leaveCode" class="form-control" name="leaveCode" value="{{ old('leaveCode') }}"required>
                            @error('leaveCode')
