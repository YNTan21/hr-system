        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                ...
                <form action="{{ route('admin.annual-leave-balance.store') }}" method="POST">
                    ...
                    <div class="mb-6 px-5">
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employee Name</label>
                        <input type="text" id="username" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white cursor-not-allowed" value="{{ $user->username }}" readonly>
                    </div>
