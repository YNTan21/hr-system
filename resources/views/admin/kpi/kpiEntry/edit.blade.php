    ...
    <div class="container-fluid">
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                <!-- Page Title -->
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Edit KPI Entry</h2>
                    ...
                    <form action="{{ route('admin.kpi.kpiEntry.update', $entry->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" 
                                   ...
                                   id="actual_result" 
                                   name="actual_result" 
                                   value="{{ old('actual_result', $entry->actual_result) }}"
                                   required>
                            @error('actual_result')
