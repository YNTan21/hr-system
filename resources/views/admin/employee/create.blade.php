                ...
                <form action="{{ route('admin.employee.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm mb-4 flex items-center gap-4 dark:bg-gray-800">
                            ...
                            <img id="preview" src="#" alt="Profile Picture Preview" style="display:none; max-width: 120px; max-height: 120px; margin-left: 1rem;">
                        </div>
                        <!-- Name and IC -->
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                ...
                                <input type="text" name="ic" id="ic" value="{{ old('ic') }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                ...
                                <div class="relative flex-1">
                                    <input type="text" name="dob" id="dob" value="{{ old('dob') }}" class="flex-1 pl-10 rounded-md border-2 border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm py-2" placeholder="Select date" autocomplete="off" required>
                            ...
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                ...
                                <div class="flex-1 relative overflow-visible">
                                    <button id="dropdownGenderButton" type="button" class="flex-1 bg-white border-2 border-blue-200 rounded-lg shadow-sm text-gray-900 text-sm px-5 py-2.5 text-left inline-flex items-center justify-between dark:bg-gray-700 dark:border-blue-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <span id="selectedGender">{{ old('gender') ? ucfirst(old('gender')) : 'Select Gender' }}</span>
                        ...
                        <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm mb-4 flex items-center gap-4 dark:bg-gray-800">
                            ...
                            <input type="tel" name="phone" id="phone" value="{{ old('phone') }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm" required>
                        </div>
                            ...
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex flex-col gap-2 dark:bg-gray-800">
                                ...
                                <div class="flex-1 relative overflow-visible">
                                    <button id="dropdownMaritalButton" type="button" class="w-full bg-white border-2 border-blue-200 rounded-lg shadow-sm text-gray-900 text-sm px-5 py-2.5 text-left inline-flex items-center justify-between dark:bg-gray-700 dark:border-blue-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <span id="selectedMarital">{{ old('marital_status') ? ucfirst(old('marital_status')) : 'Select Status' }}</span>
                                        <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
                                    </button>
                                    ...
                                    <input type="hidden" name="marital_status" id="marital_status" value="{{ old('marital_status') }}" required>
                                </div>
                            </div>
                            <!-- Nationality -->
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex flex-col gap-2 dark:bg-gray-800">
                                ...
                                <div class="flex-1 relative overflow-visible">
                                    <button id="dropdownNationalityButton" type="button" class="w-full bg-white border-2 border-blue-200 rounded-lg shadow-sm text-gray-900 text-sm px-5 py-2.5 text-left inline-flex items-center justify-between dark:bg-gray-700 dark:border-blue-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <span id="selectedNationality">{{ old('nationality') ? ucfirst(old('nationality')) : 'Select Nationality' }}</span>
                                        <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
                                    </button>
                                    ...
                                    <input type="hidden" name="nationality" id="nationality" value="{{ old('nationality') }}" required>
                                </div>
                                <!-- Specify Nationality (conditionally shown) -->
                                <div id="non-malaysian-input" class="mt-2" style="display: none;">
                                    <label for="specific_nationality" class="text-sm font-semibold text-gray-700 dark:text-white mb-1">Specify Nationality</label>
                                    <input type="text" name="specific_nationality" id="specific_nationality" value="{{ old('specific_nationality') }}" class="rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
                                </div>
                            </div>
                        </div>
                        <!-- Address -->
                        <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm mb-4 flex items-center gap-4 dark:bg-gray-800">
                            ...
                            <textarea name="address" id="address" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm" required>{{ old('address') }}</textarea>
                        </div>
                    </div>
                    <!-- Bank Information -->
                    <div class="mb-6">
                        ...
                        <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm mb-4 flex items-center gap-4 dark:bg-gray-800">
                            ...
                            <div class="flex-1 relative overflow-visible">
                                <button id="dropdownBankButton" type="button" class="flex-1 bg-white border-2 border-blue-200 rounded-lg shadow-sm text-gray-900 text-sm px-5 py-2.5 text-left inline-flex items-center justify-between dark:bg-gray-700 dark:border-blue-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    <span id="selectedBank">{{ old('bank_name') ? old('bank_name') : 'Select a bank' }}</span>
                                    <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
                                </button>
                                <div id="dropdownBank" class="z-50 hidden bg-white border border-blue-200 rounded-lg shadow-lg w-56 left-0 absolute mt-1 dark:bg-white max-h-48 overflow-y-auto">
                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownBankButton">
                                        ...
                                        <li><a href="#" class="block px-4 py-2 hover:bg-gray-100" data-value="Bank SimpananNasional">Bank SimpananNasional</a></li>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                ...
                                <input type="text" name="bank_account_holder_name" id="bank_account_holder_name" value="{{ old('bank_account_holder_name') }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm" required>
                            </div>
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                <div class="flex items-center min-w-max">
                                    <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center mr-3">
                                ...
                                <input type="text" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number') }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm" required>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div class="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm flex items-center gap-4 dark:bg-gray-800">
                                ...
                                <div class="relative flex-1">
                                    <input type="text" name="hire_date" id="hire_date" value="{{ old('hire_date') }}" class="flex-1 pl-10 rounded-md border-2 border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm py-2" placeholder="Select date" autocomplete="off" required>
                                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <i class="fas fa-calendar-alt text-blue-400"></i>
                                    </span>
                                </div>
...
<script>
    ...
    // Show/hide nationality input on load
